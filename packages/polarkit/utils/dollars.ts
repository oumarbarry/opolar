export const getCentsInDollarString = (cents: number, showCents = false, pretty = false): string => {
...
export const formatCurrencyAndAmount = (currency: string, cents: number, showCents = false): string => {
